...
namespace Shiny
{
	...
	public partial class InAppBilling : IInAppBilling
	{
        ...
        /// </summary>
        public Storefront Storefront => HasStorefront ? (storefront ??= new Storefront
        {
        ...
        public Task<IEnumerable<InAppBillingPurchase>> GetPurchasesHistoryAsync(ItemType itemType, CancellationToken cancellationToken = default) => throw new NotImplementedException();
        ...
        /// <returns></returns>
        public async Task<IEnumerable<(string Id, bool Success)>> FinalizePurchaseOfProductAsync(string[] productIds, CancellationToken cancellationToken)
        {
            var purchases = await RestoreAsync(cancellationToken);
        ...
        public Task<bool> ConnectAsync(bool enablePendingPurchases = true,
			...
			foreach (var transaction in transactions)
			{
				...
				switch (transaction.TransactionState)
				{
					...
					case SKPaymentTransactionState.Purchased:
                        ...
                        if(InAppBilling.FinishAllTransactions)
                            SKPaymentQueue.DefaultQueue.FinishTransaction(transaction);
                        break;
	...
	static class SKProductExtension
	{
        ...
        {
            if (!InAppBilling.HasIntroductoryOffer)
                return null;
        ...
        public static InAppBillingProductDiscount ToProductDiscount(this SKProductDiscount pd)
        {
            ...
            if(InAppBilling.HasProductDiscounts)
            {
